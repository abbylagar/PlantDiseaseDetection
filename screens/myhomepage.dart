...
import 'package:plant/screens/aboutpage.dart';
import 'package:plant/screens/disease_collection.dart';
import 'package:plant/screens/featuredPlant.dart';
import 'package:plant/screens/plant_collection.dart';
import 'package:plant/screens/recognize.dart';
import 'package:plant/screens/settings.dart';
import 'package:plant/screens/trivia_collection.dart';
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Container(padding:EdgeInsets.all(1),width:screenW,height: screenH*0.15,
                   decoration: BoxDecoration(color:Colors.white,borderRadius:BorderRadiusDirectional.circular(screenH*0.05)),
  
                    child: Column(mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Row(mainAxisAlignment: MainAxisAlignment.spaceAround,children: <Widget>[
                      Container(
                        child: Text("Hello There!",style: TextStyle(fontSize: screenH*0.07),)),
                      CircleAvatar(radius: screenH*0.06,backgroundImage: AssetImage('assets/images/design2.png'),)
                     ],)
                      ,], )),
              ),

         Container(padding:EdgeInsets.all(5),height:MediaQuery.of(context).size.height*0.3,
          child:
         ...
         Container(
           ...
           children:[ 
            ...
            SizedBox(height: screenH*0.02,),
             ...
             children: <Widget>[_features(image:Icon(Icons.more_vert_outlined),title: "Plant Collection",width: screenW*0.4,height: screenH*0.02,pageroute: PlantCollection(),)
             ,_features(image:Icon(Icons.note),title: "Plant Diseases",width: screenW*0.4,height: screenH*0.02,pageroute: DiseaseCollection(),)
           ]),
           SizedBox(height: screenH*0.02,),
            
            Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly,
             children: <Widget>[_features(image:Icon(Icons.lightbulb),title: "Plant Trivias",width: screenW*0.4,height: screenH*0.02,pageroute: TriviaCollection(),)
             ,_features(image:Icon(Icons.camera),title: "Detect Disease",width: screenW*0.4,height: screenH*0.02,pageroute: Recognize()),
           ]
                )]       ))
           ])                            
      ))  
        ...
        child: Column(
          children: [
            Container(
             ...
             width: _sizeW * 0.3,
//              height: _sizeH*0.1,
                child: Text(title),alignment: Alignment.center,),
          ],
        ),
      ),
    );
